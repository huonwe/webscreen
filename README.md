...
Download the latest [release](https://github.com/huonwe/webscreen/releases), execute the program. The default port is `8079`, but you can specifiy it by `-port 8080`. 6-digtal PIN is also needed (default to '123456'). A example command: `./webscreen -port 8080 -pin 555555`
