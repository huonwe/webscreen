...
func (sm *StreamManager) createScrcpyUHIDCreateEvent(wsMsg []byte) (scrcpy.UHIDCreateEvent, error) {
...
func (sm *StreamManager) createScrcpyUHIDInputEvent(wsMsg []byte) (scrcpy.UHIDInputEvent, error) {
	// WS Packet:
	// 0: Type (13)
...
func (sm *StreamManager) createScrcpyUHIDDestroyEvent(wsMsg []byte) (scrcpy.UHIDDestroyEvent, error) {
	// WS Packet:
	// 0: Type (14)
	// 1-2: Device ID (uint16)
